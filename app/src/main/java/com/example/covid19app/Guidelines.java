...
public class Guidelines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web.loadUrl("https://www.cdc.gov/coronavirus/2019-ncov/communication/guidance-list.html?Sort=Date%3A%3Adesc&Search=mask");

        WebSettings webSettings = new getSettings();
        webSettings.setJavaScriptEnabled(true);
    }

    private class getSettings extends WebSettings {
        @Override
